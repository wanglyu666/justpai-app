    ...
    <view class="content">
      ...
      <view class="defect-list">
        ...
        >
          ...
          <view class="defect-field">
            <text class="field-label">汇报时间</text>
        ...
        <view class="detail-content" v-if="selectedItem">
          ...
          <view class="info-card">
            <view class="info-block">
              <text class="info-label">缺陷名称</text>
              <text class="info-value info-value-lg">{{ selectedItem.name }}</text>
            </view>
            <view class="info-divider" />
            <view class="info-block">
              <text class="info-label">缺陷内容</text>
            ...
            <view class="info-meta-row">
              <view class="info-block info-block-grow">
                <text class="info-label">汇报时间</text>
            ...
            <view class="info-meta-row">
              <view class="info-block info-block-grow">
                ...
                <text class="info-value">{{ displayTime(selectedItem.plannedAt) }}</text>
              </view>
              <view class="info-block info-block-grow">
                <text class="info-label">实际完成时间</text>
                <text class="info-value">{{ displayTime(selectedItem.actualAt) }}</text>
              </view>
            </view>
          </view>
