    ...
    <view class="content">
      <view class="title-row">
        <view class="title-block">
          <text class="page-title">{{ t('defect.title') }}</text>
          <text class="page-desc">{{ t('defect.description') }}</text>
        </view>
      ...
      <view class="defect-list">
        ...
        <view v-if="filteredItems.length === 0" class="empty-tip">
          <text class="empty-tip-text">{{ t('defect.empty') }}</text>
        </view>
      </view>
    </view>
      ...
      <view class="detail-page">
        ...
        <view class="detail-content" v-if="selectedItem">
          <view class="detail-title-row">
            <text class="detail-title">{{ t('defect.details') }}</text>
      ...
      <SuccessPageTransition :show-success="formStep === 'success'">
        ...
        <template #success>
          <FeedbackSuccessContent
            :desc="t('defect.submitted')"
            :back-text="t('defect.back')"
            @back="closeForm"
          />
        </template>
