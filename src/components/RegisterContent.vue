<template>
  <view class="register-page">
    ...
    <view class="register-hero">
      <view class="register-hero-frame">
        <image src="/static/images/carpet.png" mode="aspectFit" class="register-hero-image" />
        <view class="register-hero-fade" />
      </view>
    </view>
